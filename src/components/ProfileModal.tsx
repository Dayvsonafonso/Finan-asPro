    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Meu Perfil">
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center text-center pb-6 border-b border-gray-100 dark:border-gray-800">
          ...
          {isGoogleUser && (
            <span className="mt-2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400">
